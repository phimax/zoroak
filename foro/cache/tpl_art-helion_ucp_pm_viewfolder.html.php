<?php if (!defined('IN_PHPBB')) exit; $this->_tpldata['DEFINE']['.']['UCP_PM'] = TRUE; $this->_tpl_include('ucp_header.html'); if (! $this->_rootref['PROMPT']) {  $this->_tpl_include('ucp_pm_message_header.html'); } if ($this->_rootref['PROMPT']) {  ?>
