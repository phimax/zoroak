...
<div class="panel">
	...
	<?php if (sizeof($this->_tpldata['attachrow'])) {  ?>
		...
		<ul class="topiclist">
			<li class="header">
				<dl>
					<dt><a href="<?php echo (isset($this->_rootref['U_SORT_FILENAME'])) ? $this->_rootref['U_SORT_FILENAME'] : ''; ?>"><?php echo ((isset($this->_rootref['L_FILENAME'])) ? $this->_rootref['L_FILENAME'] : ((isset($user->lang['FILENAME'])) ? $user->lang['FILENAME'] : '{ FILENAME }')); ?></a></dt>
